; (function($, window, document, undefined) {
    ...
    $.extend(Chocolat.prototype, {
        ...
        fit : function(i, container) {
            var height;
            var width;
            //var imgHeight = $('.chocolat-wrapper').outerHeight(true) - $('.chocolat-wrapper .chocolat-description').height() - $('.chocolat-wrapper .chocolat-true').height()
            ...
            return {
                'height' : height,
                'width'  : width,
                'top' : ((holderHeight - height)/2 - $('.chocolat-wrapper .chocolat-description').height()/2 ),
                //'top' : (holderHeight - height)/2 - $('.chocolat-wrapper .chocolat-description').height(),
